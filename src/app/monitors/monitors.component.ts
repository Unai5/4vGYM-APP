...
export class MonitorsComponent implements OnInit {
  ...
  get slicedMonitors() {
    return this.filteredMonitors.slice(this.currentIndex, this.currentIndex + this.cardsToShow);
  }
  ...
  next() {
    if (this.currentIndex < this.filteredMonitors.length - this.cardsToShow) {
      this.currentIndex++;
    }
  }
